...
public class Token implements Constants {
    ...
    public Token(Context context, Activity activity, String phone, String code) {
        ...
        StringRequest userStringRequest = new StringRequest(Request.Method.POST, URL_TOKEN, response -> {
            ...
            Log.d("Response error 2: " + error.toString());
