...
public class UnpublishedAdsAdapter extends BaseAdapter {
    ...
    public UnpublishedAdsAdapter(Context context, String [] titles, String [] address, String [] prices, int [] images){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.ads_unpublished_list_item, parent, false);
