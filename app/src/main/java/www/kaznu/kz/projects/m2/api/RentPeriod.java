...
public class RentPeriod implements Constants {
    ...
    public RentPeriod(Context context) {
        this.context = context;
        this.directories = new ArrayList<>();
        this.listener = null;

        RequestQueue requestQueue = Volley.newRequestQueue(this.context);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_GET_RENT_PERIOD, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    ArrayList<Directory> realtyTypes = new ArrayList<Directory>();
