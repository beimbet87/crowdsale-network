...
public class UpdateRealtyProperties implements Constants {
    ...
    public UpdateRealtyProperties(Context context, ArrayList<ConfigValue> configValue, String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_UPDATE_REALTY_PROPERTIES, new Response.Listener<String>() {
            @Override
