...
public class UserInfoWithID implements Constants {
    ...
    public UserInfoWithID(Context context, String userId, String t) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_GET_USER_INFO.concat("?userID=").concat(userId), new Response.Listener<String>() {
            @Override
