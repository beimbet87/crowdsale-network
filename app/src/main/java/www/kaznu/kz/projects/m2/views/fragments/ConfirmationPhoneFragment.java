...
public class ConfirmationPhoneFragment extends Fragment {
    ...
    public ConfirmationPhoneFragment() {
    }

    public interface DataFromConfirmationPhoneFragment {
        void FromConfirmationPhoneFragment(String data, int number);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fv = inflater.inflate(R.layout.fragment_confirmation_phone, container, false);
        ...
        dataPasser.FromConfirmationPhoneFragment("Подтверждение", 3);
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            confirm.setOnLoadListener(new IdentityConfirmation.CustomOnLoadListener() {
                ...
                public void onComplete(int resultCode, String resultMessage) {
                    if(resultCode == 1) {
                        Toast.makeText(requireContext(), "Номер телефона успешно изменен!", Toast.LENGTH_SHORT).show();
    ...
    DataFromConfirmationPhoneFragment dataPasser;

    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        dataPasser = (DataFromConfirmationPhoneFragment) context;
    }
}