...
public class UserRate implements Constants {
    ...
    public UserRate(Context context, int idUser, int asOwner, String token) {

        this.listener = null;

        String URL = URL_RATE_USER.concat("?idUser=")
                .concat(String.valueOf(idUser))
                .concat("&asowner=")
                .concat(String.valueOf(asOwner));
