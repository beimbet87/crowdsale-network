...
public class RateUser implements Constants {
    ...
    public RateUser(Context context, Message message, String token) {

        RequestQueue requestQueue = Volley.newRequestQueue(context);

        final String requestBody = message.getRateBookUser();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_PUSHER_RATE_USER, new Response.Listener<String>() {
            @Override
