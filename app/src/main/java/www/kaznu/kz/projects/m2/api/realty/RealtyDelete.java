...
public class RealtyDelete implements Constants {
    ...
    public RealtyDelete(Context context, int reatlyid, String token) {
        String params = "?realtyid=" + reatlyid;

        RequestQueue requestQueue = Volley.newRequestQueue(context);

        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_DELETE_REALTY.concat(params), new Response.Listener<String>() {
            @Override
