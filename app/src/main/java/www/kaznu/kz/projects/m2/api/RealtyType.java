...
public class RealtyType implements Constants {
    ...
    public RealtyType(Context context) {
        this.context = context;
        this.directories = new ArrayList<>();
        this.listener = null;

        RequestQueue requestQueue = Volley.newRequestQueue(this.context);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_GET_REALTY_TYPE, new Response.Listener<String>() {
            @Override
