...
public class RateBook implements Constants {
    ...
    public RateBook(Context context, Message message, String token) {

        Logger Log = new Logger(context, TAG);

        RequestQueue requestQueue = Volley.newRequestQueue(context);

        final String requestBody = message.getRateBookBody();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_PUSHER_RATE_BOOK, new Response.Listener<String>() {
            @Override
