...
public class RequestMessage implements Constants {
    ...
    public RequestMessage(Context context, Message message, String token) {

        Logger Log = new Logger(context, TAG);

        RequestQueue requestQueue = Volley.newRequestQueue(context);

        final String requestBody = message.getRequestBody();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_PUSHER_REQUEST_MESSAGE, new Response.Listener<String>() {
            @Override
