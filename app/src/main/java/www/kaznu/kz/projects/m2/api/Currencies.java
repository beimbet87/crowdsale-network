...
public class Currencies implements Constants {
    ...
    public Currencies(Context context) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_GET_CURRENCIES, new Response.Listener<String>() {
            @Override
