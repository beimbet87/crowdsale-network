...
public class SetSearchPublic implements Constants {
    ...
    public SetSearchPublic(Context context, int searchid, int status, String token) {
        String params = "?searchid=" + searchid + "&status=" + status;

        RequestQueue requestQueue = Volley.newRequestQueue(context);

        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_SET_SEARCH_PUBLIC.concat(params), new Response.Listener<String>() {
            @Override
