...
public class SendMessage implements Constants {
    ...
    public SendMessage(Context context, Message message, String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_PUSHER_SEND_MESSAGE, new Response.Listener<String>() {
            @Override
